...
} from "./chunk-VCKOMTA4.js";
import {
  Label,
  Layer,
  Text,
  getStringSize
} from "./chunk-ZSKIUXLB.js";
import {
  adaptEventsOfChild,
  filterProps,
  shallowEqual
} from "./chunk-2C32M5S5.js";
import {
  Global
} from "./chunk-MDQRXIGY.js";
import {
  clsx_default,
  isNumber,
  mathSign,
...
var CartesianAxis = function(_Component) {
  ...
  return _createClass(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread2(_objectSpread2(_objectSpread2({}, filterProps(this.props, false)), filterProps(axisLine, false)), {}, {
        fill: "none"
      });
      ...
      return import_react.default.createElement("line", _extends({}, props, {
        className: clsx_default("recharts-cartesian-axis-line", (0, import_get.default)(axisLine, "className"))
      }));
    }
  }, {
    key: "renderTicks",
    value: (
      ...
      function renderTicks(ticks, fontSize, letterSpacing) {
        ...
        var finalTicks = getTicks(_objectSpread2(_objectSpread2({}, this.props), {}, {
          ticks
        ...
        var tickLineProps = _objectSpread2(_objectSpread2({}, axisProps), {}, {
          fill: "none"
        }, filterProps(tickLine, false));
        var items = finalTicks.map(function(entry, i) {
          var _this2$getTickLineCoo = _this2.getTickLineCoord(entry), lineCoord = _this2$getTickLineCoo.line, tickCoord = _this2$getTickLineCoo.tick;
          var tickProps = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({
            textAnchor,
            verticalAnchor
          }, axisProps), {}, {
            stroke: "none",
          ...
          return import_react.default.createElement(Layer, _extends({
            className: "recharts-cartesian-axis-tick",
            key: "tick-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && import_react.default.createElement("line", _extends({}, tickLineProps, lineCoord, {
            className: clsx_default("recharts-cartesian-axis-tick-line", (0, import_get.default)(tickLine, "className"))
          })), tick && CartesianAxis2.renderTickItem(tick, tickProps, "".concat((0, import_isFunction2.default)(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || "")));
        });
    ...
    value: function render() {
      ...
      if ((0, import_isFunction2.default)(ticksGenerator)) {
        finalTicks = ticks && ticks.length > 0 ? ticksGenerator(this.props) : ticksGenerator(noTicksProps);
      }
      if (width <= 0 || height <= 0 || !finalTicks || !finalTicks.length) {
        return null;
      }
      return import_react.default.createElement(Layer, {
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (import_react.default.isValidElement(option)) {
        tickItem = import_react.default.cloneElement(option, _objectSpread2(_objectSpread2({}, props), {}, {
          className: combinedClassName
        }));
      } else if ((0, import_isFunction2.default)(option)) {
        tickItem = option(_objectSpread2(_objectSpread2({}, props), {}, {
          className: combinedClassName
        }));
      } else {
        tickItem = import_react.default.createElement(Text, _extends({}, props, {
...
_defineProperty2(CartesianAxis, "displayName", "CartesianAxis");
_defineProperty2(CartesianAxis, "defaultProps", {
  x: 0,
  y: 0,
  width: 0,
  height: 0,
...
//# sourceMappingURL=chunk-67XYLRQN.js.map
