...
import "./chunk-C3YABKB7.js";
import "./chunk-YKP6OIW5.js";
import {
  getCoordinatesOfGrid,
  getTicksOfAxis
} from "./chunk-ZSKIUXLB.js";
import "./chunk-HQBQ527D.js";
import {
  filterProps,
  warn
} from "./chunk-2C32M5S5.js";
import "./chunk-MDQRXIGY.js";
import {
  isNumber,
  require_isFunction
...
function renderLineItem(option, props) {
  ...
  if (import_react.default.isValidElement(option)) {
    lineItem = import_react.default.cloneElement(option, props);
    ...
    var _filterProps = filterProps(others, false), __ = _filterProps.offset, restOfFilteredProps = _objectWithoutProperties(_filterProps, _excluded2);
    lineItem = import_react.default.createElement("line", _extends({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function CartesianGrid(props) {
  ...
  }, import_react.default.createElement(Background, {
  ...
  }), import_react.default.createElement(HorizontalGridLines, _extends({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), import_react.default.createElement(VerticalGridLines, _extends({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
  })), import_react.default.createElement(HorizontalStripes, _extends({}, propsIncludingDefaults, {
    horizontalPoints
  })), import_react.default.createElement(VerticalStripes, _extends({}, propsIncludingDefaults, {
    verticalPoints
  })));
}
...
//# sourceMappingURL=recharts_es6_cartesian_CartesianGrid.js.map
