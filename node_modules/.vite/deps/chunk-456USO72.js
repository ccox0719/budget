...
var Pie = function(_PureComponent) {
  function Pie2(props) {
    ...
    _defineProperty(_this, "handleAnimationEnd", function() {
      ...
      if ((0, import_isFunction.default)(onAnimationEnd)) {
        onAnimationEnd();
      }
    });
    _defineProperty(_this, "handleAnimationStart", function() {
      ...
      if ((0, import_isFunction.default)(onAnimationStart)) {
        onAnimationStart();
      }
    });
    _this.state = {
  ...
  return _createClass(Pie2, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var labels = sectors.map(function(entry, i) {
        ...
        return (
          ...
          import_react.default.createElement(Layer, {
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), import_react.default.createElement(Shape, _extends({
    ...
    value: function renderSectorsWithAnimation() {
      ...
      return import_react.default.createElement(es6_default, {
        ...
        return import_react.default.createElement(Layer, null, _this3.renderSectorsStatically(stepData));
      });
    }
  }, {
    ...
    value: function renderSectors() {
      ...
      if (isAnimationActive && sectors && sectors.length && (!prevSectors || !(0, import_isEqual.default)(prevSectors, sectors))) {
    ...
    value: function renderLabelLineItem(option, props, key) {
      if (import_react.default.isValidElement(option)) {
        return import_react.default.cloneElement(option, props);
      }
      ...
      return import_react.default.createElement(Curve, _extends({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return import_react.default.createElement(Text, _extends({}, props, {
...
//# sourceMappingURL=chunk-456USO72.js.map
